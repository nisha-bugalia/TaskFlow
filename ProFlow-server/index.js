...
app.post('/api/upload', upload.single('image'), async (req, res) => {
  ...
  try {
    ...
    const outPath = path.join(__dirname, 'uploads', 'cropped_' + path.basename(filePath));
    ...
    res.status(400).json({ error: "No Face Detected. Try another Image for Profile Photo." });
  }
});
app.listen(PORT,()=>{
